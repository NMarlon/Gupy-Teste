...
if(true){//ESCOLHA MOCKAPI? então true senão false
  const thisdata = request('https://614225344d16670017ba2c39.mockapi.io/api/teste/TipoDeProfissional', (error, response, body) => {
